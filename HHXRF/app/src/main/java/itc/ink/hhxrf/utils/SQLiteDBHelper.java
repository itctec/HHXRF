...
public class SQLiteDBHelper extends SQLiteOpenHelper {
    ...
    private final String TB_CREATE_HISTORY_DATA="create table tb_history_data(sample_name PRIMARY KEY,test_datetime DATETIME,test_way,calibration_type)";
    private final String TB_CREATE_HISTORY_DATA_CONTENT="create table tb_history_data_content(element_name,element_concentration float,element_range,element_average,sample_name,FOREIGN KEY(sample_name) REFERENCES tb_history_data(sample_name) on update cascade on delete cascade)";
